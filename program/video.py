...
async def vplay(c: Client, m: Message):
    ...
    try:
        ...
        if b.status == "kicked":
            await m.reply_text(
                f"@{ASSISTANT_NAME} **ᴛʜɪꜱ ʙʟᴀᴄᴋ ᴄᴀᴛ ᴏᴘ ᴀꜱꜱɪꜱᴛᴀɴᴛ ʙᴀɴɴᴇᴅ ɪɴ** {m.chat.title}\n\n» **ᴀꜱꜱɪꜱᴛᴀɴᴛ ᴛʜᴇ ᴜꜱᴇʀʙᴏᴛ ꜰɪʀꜱᴛ ᴀɴᴅ ᴛʜᴇɴ ᴀᴅᴅ ᴛʜᴇᴍ ᴍᴀɴᴜᴀʟʟʏ. ɪꜰ ᴜ ʜᴀᴠᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ᴛʜᴇɴ ᴄᴏɴᴛᴀᴄᴛ ᴜꜱ ᴀᴛ ꜱᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ ɢʀᴏᴜᴘ.**\n\n© @catmusicworld"
            )
            return
